  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 md:p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Enhanced Header with subtle animation and glow */}
        <div className="text-center mb-12 animate-fade-in">
          <div className="relative inline-block">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent mb-4 glow-text">
              <span className="glow-text">Multi-Agent Retail Inventory System</span>
            </h1>
            <div className="absolute -top-2 -left-2 w-full h-full bg-gradient-to-r from-purple-600/20 to-blue-600/20 blur-xl -z-10"></div>
          </div>
          <p className="text-purple-200 text-lg max-w-2xl mx-auto glow-text">
            AI-Powered Inventory Optimization & Management Platform
          </p>
          <div className="mt-4 flex justify-center">
            <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 neon-border">
        ...
        {/* Enhanced Key Metrics with glow/neon effects */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border-white/20 hover:border-green-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-green-400/10 hover:scale-105 neon-border futuristic-card">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-200 text-sm font-medium">Total Revenue</p>
                  <p className="text-white text-3xl font-bold glow-text">$2.4M</p>
                ...
                <div className="p-3 bg-green-400/10 rounded-xl group-hover:bg-green-400/20 transition-colors">
                  <DollarSign className="w-8 h-8 text-green-400 glow-text" />
                </div>
              </div>
            </CardContent>
          </Card>

          <Card className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border-white/20 hover:border-blue-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-blue-400/10 hover:scale-105 neon-border futuristic-card">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-200 text-sm font-medium">Inventory Items</p>
                  <p className="text-white text-3xl font-bold glow-text">15,847</p>
                ...
                <div className="p-3 bg-blue-400/10 rounded-xl group-hover:bg-blue-400/20 transition-colors">
                  <Package className="w-8 h-8 text-blue-400 glow-text" />
                </div>
              </div>
            </CardContent>
          </Card>

          <Card className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border-white/20 hover:border-purple-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-purple-400/10 hover:scale-105 neon-border futuristic-card">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-200 text-sm font-medium">Active Agents</p>
                  <p className="text-white text-3xl font-bold glow-text">
                ...
                <div className="p-3 bg-purple-400/10 rounded-xl group-hover:bg-purple-400/20 transition-colors">
                  <Users className="w-8 h-8 text-purple-400 glow-text" />
                </div>
              </div>
            </CardContent>
          </Card>

          <Card className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border-white/20 hover:border-emerald-400/40 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-400/10 hover:scale-105 neon-border futuristic-card">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-200 text-sm font-medium">System Efficiency</p>
                  <p className="text-white text-3xl font-bold glow-text">93%</p>
                ...
                <div className="p-3 bg-emerald-400/10 rounded-xl group-hover:bg-emerald-400/20 transition-colors">
                  <CheckCircle className="w-8 h-8 text-emerald-400 glow-text" />
                </div>
              </div>
            </CardContent>
          </Card>
